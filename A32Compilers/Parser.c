...
atys_void matchToken(atys_intg tokenCode, atys_intg tokenAttribute) {
	atys_intg matchFlag = 1;
...
atys_void syncErrorHandler(atys_intg syncTokenCode) {
	printError();
	syntaxErrorNumber++;
